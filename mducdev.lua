...
local function CalculateHeight(mobPosition)
    if getgenv().AuraFruit and _G.ChooseWP == "Blox Fruit" then
        return mobPosition.Y + 10  -- Trang bị Fruit + bật Aura Fruit: Y+10
    end
    if _G.ChooseWP == "Blox Fruit" then
        return mobPosition.Y + 10  -- Fruit: Y+15
    end
...
-- Up:        Y+40 (Melee/Sword) / Y+30 (Gun) / Y+15 (Fruit/AuraFruit), đứng thẳng trên mob
...
local function GetFarmCFrame(mob)
    ...
    if getgenv().AuraFruit and _G.ChooseWP == "Blox Fruit" then
        targetPos = Vector3.new(mobPos.X + OFFSET_X, mobPos.Y + 10, mobPos.Z + OFFSET_Z)
    elseif _G.ChooseWP == "Blox Fruit" then
        targetPos = Vector3.new(mobPos.X + OFFSET_X, mobPos.Y + 10, mobPos.Z + OFFSET_Z)
    else
        -- Up (mặc định)
        if _G.ChooseWP == "Melee" or _G.ChooseWP == "Sword" then
            targetPos = Vector3.new(mobPos.X + OFFSET_X, mobPos.Y + 40, mobPos.Z + OFFSET_Z)
        else
